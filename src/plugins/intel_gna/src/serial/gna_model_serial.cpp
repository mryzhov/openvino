 ...
 */
class mem_stringbuf : public std::streambuf {
    std::string data;
protected:
...
inline size_t get_buffer_size(std::stringstream& stream) {
        ...
        case 2:
            switch (header.version.minor) {
                ...
                case 9:
                    ...
                    break;
                default:
                    THROW_GNA_EXCEPTION << "Imported file unsupported. minor version should have values in range 1 to 9 and is: " << header.version.minor;
            }
            break;
        default:
        ...
        case 2:
            switch (model_header_.version.minor) {
                ...
                case 9:
                    ...
                    break;
                default:
                    THROW_GNA_EXCEPTION << "Imported file unsupported. minor version should have values in range 1 to 9 and is: "
