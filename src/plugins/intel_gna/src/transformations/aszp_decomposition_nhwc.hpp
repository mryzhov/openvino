...
class ConvertAsymmetricPadToSymmetricPad : public ov::pass::MatcherPass {
public:
    OPENVINO_RTTI("ConvertAsymmetricPadToSymmetricPad", "0");
    ConvertAsymmetricPadToSymmetricPad();
};
