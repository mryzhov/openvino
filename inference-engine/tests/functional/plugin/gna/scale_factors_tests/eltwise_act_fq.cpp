...
protected:
    void SetUp() override {
        ...
        auto lowNodeIn = ngraph::builder::makeConstant<float>(ngPrc, {1}, { sf_reducer * inputDataMin });
        auto highNodeIn = ngraph::builder::makeConstant<float>(ngPrc, {1}, { sf_reducer * inputDataMax });
